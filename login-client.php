                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="titlepage">
                                    <span>You don't have an Account? <a
                                            href="<?php echo 'http://localhost/blessed/'; ?>register-client.php"><strong>Register</strong></a>
                                    </span>
                                </div>
                            </div>
    ...
    if(isset($_POST['submit']))
    {
      ...
      //  echo $_POST['password'];
        ...
        if($count==1)
        {
            ...
            $_SESSION['client'] = $id_client; //TO check whether the user is logged in or not and logout will unset it
//nzid session[role] = $role
$_SESSION['role']=$role;
            //REdirect to HOme Page/Dashboard
           // header("location:".SITE_URL."index-client.php?id=$id_client");
