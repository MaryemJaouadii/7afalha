...
<?php 
    ...
    if(isset($_GET['id']))
    {
        ...
        $sql2 = "SELECT * FROM content_managament WHERE id=$id";
        //execute the Query
    ...
    <div class="wrapper">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        else
                        {
                            //Image Available
                            ?>
                        <img src="<?php echo SITE_URL; ?>images/content/<?php echo $current_image; ?>" width="150px">
                        <?php
                        }
                    ?>
                    </td>
        ...
        <?php 
            ...
            if(isset($_POST['submit']))
            {
                ...
                $sql3 = "UPDATE content_managament SET 
                    title = '$title',
